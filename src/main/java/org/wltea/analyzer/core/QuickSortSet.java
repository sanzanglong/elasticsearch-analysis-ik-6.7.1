...
class QuickSortSet {
    ...
    boolean addLexeme(Lexeme lexeme) {
        ...
        if (this.size == 0) {
            ...
            if (this.tail.compareTo(newCell) == 0 && !lexeme.isLexemeBitBoot()) {
            ...
            } else if (this.tail.compareTo(newCell) == 0) {//词元与尾部词元相同，不放入集合
//			if(this.tail.compareTo(newCell) == 0){//词元与尾部词元相同，不放入集合
                return false;

            } else
//				if(this.tail.compareTo(newCell) < 0 || !lexeme.isLexemeBitBoot()){//词元接入链表尾部
                if (this.tail.compareTo(newCell) < 0) {//词元接入链表尾部
                    ...
                    if (index.compareTo(newCell) == 0 && !lexeme.isLexemeBitBoot()) {//词元与集合中的词元重复，不放入集合
						newCell.prev = index;
                    ...
                    } else if (index.compareTo(newCell) == 0) {//词元与集合中的词元重复，不放入集合
                        return false;
